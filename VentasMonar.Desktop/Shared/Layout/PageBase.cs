...
{
    public partial class PageBase : RadForm
    {
        public PageBase()
        {
            InitializeComponent();
        ...
        public static string Strconexion = ""; //"Database=" + BaseDatos.Id_BaseDatos + "; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;
        //public string Strconexion = ""; //"Database=" + BaseDatos.Id_BaseDatos + "; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;
       ...
       public static String NombreIni = "Conexion.ini";
        public static string Strconexionlocalglobal;// "Database=" + BaseDatos.Id_BaseDatos + "; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;//Sistema_de_Inventarios.Properties.Settings.Default.Db_LocalNetMonarConnectionString;
                                                  //public string Strconexionlocalglobal = ConfigurationManager.ConnectionStrings["SqlMonar"].ConnectionString; //"Database=" + BaseDatos.Id_BaseDatos + "; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;//Sistema_de_Inventarios.Properties.Settings.Default.Db_LocalNetMonarConnectionString;
                                                  //public string StrconexiongloblalMonar = ConfigurationManager.ConnectionStrings["SqlMonar_Anterior"].ConnectionString; //"Database=sae4; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;//Sistema_de_Inventarios.Properties.Settings.Default.Db_LocalNetMonarConnectionString;
        public static string StrconexiongloblalMonar;//"Database=sae4; Data Source=" + ServerName.Id_ServerName + ";Integrated Security=False;User Id=" + IdUserName.IdUser_Name + ";Password=" + IdPassWord.Password;//Sistema_de_Inventarios.Properties.Settings.Default.Db_LocalNetMonarConnectionString;

       
        public void Conexion()
        {
            
            Strconexion = ConfigurationManager.ConnectionStrings["SqlMonar"].ConnectionString; //"Database=" + BaseDatos + "; Data Source=" + Servidor + ";Integrated Security=False;User Id=" + Usuario + ";Password=" + Password;
            Strconexionlocalglobal = Strconexion;
            StrconexiongloblalMonar = ConfigurationManager.ConnectionStrings["SqlMonar_Anterior"].ConnectionString;
        }
        ...
        public class FormasPago
        {
            ...
            private decimal dblMonedaNacional;
            private decimal dblTipoCambio;
            ...
            private decimal dblTotalPagado;
            private decimal dblImportePagado;
            private decimal dblTotalCambio;
        ...
        protected DataTable SP_Busca_Reader(ArrayList ListParametro, string Nombre_SP)
        {
        ...
        protected DataTable SP_Busca_Reader(ArrayList ListParametro, string Nombre_SP,SqlConnection connection, SqlTransaction transaction)
        {
        ...
        protected decimal ChekExistencia(int CveProducto, ArrayList ArrayListProductosVenta)
        {
            decimal ExistenciaA = decimal.Parse(GetStrFieldQuery("Cantidad", "Select Cantidad From ProductoColor Where CveProducto=" + CveProducto));
        ...
        protected int performinsertquery(string query)
        {
            Strconexion = ConfigurationManager.ConnectionStrings["SqlMonar"].ConnectionString;
        ...
        protected void loadDataGrid(DataGridView DataGrid, string query, string strconexionLocal="")
        {
            string conexionactual = "";
            if(strconexionLocal=="")
            {
                conexionactual = Strconexion;
            }
            else
            {
                conexionactual = strconexionLocal;
            }
            using (SqlConnection con = new SqlConnection(conexionactual))
            {
                con.Open();
        ...
        protected void loadDataGrid(DataGridView DataGrid, DataTable _dt)
        {

            BindingSource _dtsource = new BindingSource();
            // _dtsource.DataSource = _dt.DefaultView ;
        ...
        protected void loadDataGrid(DataGridView DataGrid, DataView _dt)
        {

            BindingSource _dtsource = new BindingSource();
            //_dtsource.DataSource = _dt.Table.DefaultView;

            DataGrid.DataSource = _dtsource;

            colorDataGrid(DataGrid);
        }
        protected void loadDataGrid(DataGridView DataGrid, ArrayList _lista)
        {

            BindingSource _dtsource = new BindingSource();
            _dtsource.DataSource = _lista;
        ...
        protected void ConnectListbox(ListBox list, string query)
        {
            using (SqlConnection connection = new SqlConnection(Strconexion))
            {
                int flag = 0;
        ...
        protected void radConnectDropDownList(RadDropDownList list, string query, int opciontodos)
        {
            using (SqlConnection connection = new SqlConnection(Strconexion))
            {
                int flag = 0;
                ...
                if (opciontodos == 1)
                {
                    Lista.Add(new AddValue("TODOS", 0));
                }
        ...
        protected void radConnectDropDownList(RadDropDownList list, string query, string CveField, string DescriptionField, string Imagen)
        {
            using (SqlConnection connection = new SqlConnection(Strconexion))
            {
                int flag = 0;
                ...
                while (rsLista.Read())
                {
                    ...
                    item.Value = rsLista[CveField];
                    item.Text += rsLista[DescriptionField].ToString();
                    ...
                    item.Image = GetImageFromData((byte[])rsLista[Imagen]);
        ...
        public Image GetImageFromData(byte[] imageData)
        {
        ...
        protected void ConnectDropDownListMonar(ComboBox list, string query)
        {
            using (SqlConnection connection = new SqlConnection(StrconexiongloblalMonar))
            {
                int flag = 0;
                SqlCommand cmd = new SqlCommand(query, connection);
                connection.Open();
        ...
        protected void ConnectDropDownListMonar(ComboBox list, string table, string datavaluefield, string datatextfield)
        {
            int flag = 0;
            string query = "SELECT " + datavaluefield + "," + datatextfield + " FROM " + table + " ORDER BY 1";
            using (SqlConnection con = new SqlConnection(StrconexiongloblalMonar))
            {
                con.Open();
                SqlCommand cmd = new SqlCommand(query, con);
        ...
        protected bool ConnectDropDownListMonar(ComboBox list, string table, string datavaluefield, string datatextfield, int orderby)
        {
        ...
        protected void ConnectDropDownListEditSS(RadDropDownList list, string table, string datavaluefield, string datatextfield, string dataclavefield)
        {
            int flag = 0;
            string queryone = "SELECT " + datavaluefield + "," + datatextfield + " FROM " + table + " WHERE " + datavaluefield + "=" + dataclavefield + " ORDER BY 1";
            using (SqlConnection con = new SqlConnection(Strconexion))
        ...
        protected bool IsNumeric(object ValueToCheck, bool simple)
        {
            double Dummy = new double();
            string InputValue = Convert.ToString(ValueToCheck);
        ...
        public decimal GetDecimalField(string CveField, string Table, string CveFieldEqual, string CveFieldCompare)
        {
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                string queryField = "SELECT " + CveField + " FROM " + Table + " WHERE " + CveFieldEqual + "=" + CveFieldCompare;
                ...
                if (readerField.HasRows)
                {
                    ...
                    if (readerField[CveField].ToString() != "")
                    {
                        Field = decimal.Parse(readerField[CveField].ToString());
                    }
                }
        ...
        public decimal GetDecimalField(string CveField, string Query)
        {
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                string queryField = Query;
        ...
        public string GetStrFieldQuery(string CveField, string Query,SqlConnection connection, SqlTransaction transaction)
        {
            ...
            string queryField = Query;
            string Field = "";
            using (SqlCommand cmdField = new SqlCommand(queryField, connection, transaction))
            {
        ...
        public string GetStrFieldQueryMonar(string CveField, string Query)
        {
            using (SqlConnection con = new SqlConnection(StrconexiongloblalMonar))
            {
                string queryField = Query;
        ...
        public void GuardarXmlCodigo_FEL(int CveFactura, string Ruta, string Campo)
        {
            if (Ruta != null)
            {
                string Query = "Update Facturas Set " + Campo + "='" + Ruta + "' Where CveFactura=" + CveFactura;
                performupdatequery(Query, StrconexiongloblalMonar);

                //MessageBox.Show("Xml y Codigo Guardado en la Base de Datos");

            }
        }
        public void GuardarQR_FEL(int CveFactura, string Ruta, string Campo, string Variable)
        {
            if (Ruta != null)
            {
        ...
        {
            public static decimal CostoUltimaCompra(string cveproducto, string strconexion)
            {
                decimal costoultimacompra = 0;
                ...
                {
                    con.Open();
                    string queryCostoUltimaCompra = "Select isnull(UltimoCosto,0) As UltimoCosto From Productos Where CveProducto=" + cveproducto;
                    ...
                    {
                        reader.Read();
                        costoultimacompra =decimal.Parse(reader["UltimoCosto"].ToString());
        ...
        public class ProductoKit
        {
            ...
            public ProductoKit(int cantidad, string nombre, string clave, decimal preciounitario, decimal preciototal, string cveprecio, int orden)
            {
        ...
        public class ProductoCompra
        {
            ...
            public string StrNoDocumentoGenerado
            {
                get { return strNoDocumentoGenerado; }
                set { strNoDocumentoGenerado = value; }
            }

            public int IntCveNotaGenera
            {
                get { return intCveNotaGenera; }
                set { intCveNotaGenera = value; }
            }
            ...
            public decimal DblAfectar
            {
                get { return dblAfectar; }
                set { dblAfectar = value; }
            }

            public decimal DblPendiente
            {
            ...
            private decimal dblIvaPorCentaje;
            ...
            public decimal CantidadDevolucion
            {
                get
                {
            ...
            private int intIVaRetenido;
            private int intIsrRetenido;


            private decimal dblImporteIvaRetenido;
            private decimal dblImporteIsrRetenido;
            ...
            public int IntIsrRetenido { get => intIsrRetenido; set => intIsrRetenido = value; }


            public decimal DblImporteIsrRetenido { get => dblImporteIsrRetenido; set => dblImporteIsrRetenido = value; }
            public int IntIVaRetenido { get => intIVaRetenido; set => intIVaRetenido = value; }
            public decimal DblImporteIvaRetenido { get => dblImporteIvaRetenido; set => dblImporteIvaRetenido = value; }

            private int intSiIva;
            private decimal dblMonedero;
            private decimal dblPorcentaje;
            private decimal dblImporteDevolucion;
            public int IntSiIva
            {
                get { return intSiIva; }
                set { intSiIva = value; }
            ...
            public decimal DblMonedero { get => dblMonedero; set => dblMonedero = value; }
            public decimal DblPorcentaje { get => dblPorcentaje; set => dblPorcentaje = value; }
            ...
            public decimal DblImporteDevolucion { get => dblImporteDevolucion; set => dblImporteDevolucion = value; }
                ...
                using (SqlConnection con = new SqlConnection(strconexionC))
                {
                    ...
                    switch (option)
                    {
                        case 1:
                            ...
                            {
                                reader.Read();
                                decimal Existencia = reader.GetDecimal(reader.GetOrdinal("Existencia"));
                                reader.Close();
                        ...
                        case 2:
                            ...
                            {
                                reader2.Read();
                                decimal Existencia = reader2.GetDecimal(reader2.GetOrdinal("Existencia"));
                                reader2.Close();
            ...
            public int ActualizarPrecio(SqlConnection con, SqlTransaction transaction)
            {
                int actualizo = 0;
                    ...
                    SqlCommand cmd = new SqlCommand(queryPrecios, con,transaction);
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    try
                    {
                        ...
                        reader.Read();
                        decimal PorcentajeUtilidad1 = decimal.Parse(reader["PorcentajeUtilidad1"].ToString());
                        decimal PorcentajeUtilidad2 = decimal.Parse(reader["PorcentajeUtilidad2"].ToString());
                        decimal PorcentajeUtilidad3 = decimal.Parse(reader["PorcentajeUtilidad3"].ToString());
                        decimal PorcentajeUtilidad4 = decimal.Parse(reader["PorcentajeUtilidad4"].ToString());
                        decimal PorcentajeUtilidad5 = decimal.Parse(reader["PorcentajeUtilidad5"].ToString());
                        decimal PorcentajeUtilidad6 = decimal.Parse(reader["PorcentajeUtilidad6"].ToString());
                        ...
                        //string QueryUpdateProducto = "Update Productos UltimoCosto=" + Producto.PrecioUnitarioOriginal + ",CantidadUltimaCompra=" + Producto.Cantidad + ",FechaUltimaCompra='" + SwitchDate(DateTime.Now.ToShortDateString(), 1) + "', Where CveProducto=" + Producto.CveProducto;

                        string updatePrecios = "UPDATE Productos SET  UltimoCosto=" + PrecioUnitarioOriginal + ",CantidadUltimaCompra=" + Cantidad + ",FechaUltimaCompra='" + SwitchDate(DateTime.Now.ToShortDateString(), 1) + "', Precio0 =" + preciounitario.ToString() + ", Precio1=" + decimal.Parse(Precio1, System.Globalization.NumberStyles.Currency) + ", Precio2=" + decimal.Parse(Precio2, System.Globalization.NumberStyles.Currency)  + ", Precio3=" + decimal.Parse(Precio3, System.Globalization.NumberStyles.Currency) + ", Precio4=" + decimal.Parse(Precio4, System.Globalization.NumberStyles.Currency) + ", Precio5=" + decimal.Parse(Precio5, System.Globalization.NumberStyles.Currency) + ", Precio6=" + decimal.Parse(Precio6, System.Globalization.NumberStyles.Currency) + "  WHERE CveProducto=" + cveproducto;
                    ...
                    {
                    MessageBox.Show("Error Dato : " + err.Message);
                    actualizo = 0;
                    }
                }
            ...
            public int ActualizarPrecio_2(SqlConnection connection, SqlTransaction transaction, decimal Iva)
            {
                int actualizo = 0;
               
                    //Obtenemos la existencia actual del producto
                    string queryPrecios = "SELECT PorcentajeUtilidad1, PorcentajeUtilidad2, PorcentajeUtilidad3, PorcentajeUtilidad4, PorcentajeUtilidad5, PorcentajeUtilidad6 FROM Productos WHERE CveProducto=" + cveproducto;
                    SqlCommand cmd = new SqlCommand(queryPrecios, connection,transaction);
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    try
                    {
                        ...
                        //Actualizamos los precios del producto en el inventario
                        string updatePrecios = "UPDATE Productos SET Precio0=" + preciounitario.ToString() + ", Precio1=" + decimal.Parse(Precio1, System.Globalization.NumberStyles.Currency) + ", Precio2=" + decimal.Parse(Precio2, System.Globalization.NumberStyles.Currency) + ", Precio3=" + decimal.Parse(Precio3, System.Globalization.NumberStyles.Currency) + ", Precio4=" + decimal.Parse(Precio4, System.Globalization.NumberStyles.Currency) + ", Precio5=" + decimal.Parse(Precio5, System.Globalization.NumberStyles.Currency) + ", Precio6=" + decimal.Parse(Precio6, System.Globalization.NumberStyles.Currency) + "  WHERE CveProducto=" + cveproducto;
                        SqlCommand cmdU = new SqlCommand(updatePrecios,connection,transaction);
                        actualizo = cmdU.ExecuteNonQuery();

                    }
                    catch(Exception er)
                    {
                        MessageBox.Show("Error Dato : " + er.Message);
                        actualizo = 0;
                    }
            ...
            public decimal CostoUltimaCompra()
            {
                ...
                {
                    con.Open();
                    string queryCostoUltimaCompra = "Select UltimoCosto From Productos Where CveProducto=" + CveProducto;
                    SqlCommand cmd = new SqlCommand(queryCostoUltimaCompra, con);
                    SqlDataReader reader = cmd.ExecuteReader();
                    if (reader.HasRows)
                    {
            ...
            public string ObtenerPrecio_Venta(string PrecioUltimoCosto, decimal IVA, string UtilidadPrecio)
            {
                decimal PrecioCosto = decimal.Parse(PrecioUltimoCosto, System.Globalization.NumberStyles.Currency);
                string StrPUtilidad = UtilidadPrecio.Replace(System.Globalization.CultureInfo.CurrentCulture.NumberFormat.PercentSymbol, "");
                decimal PUtilidad = decimal.Parse(StrPUtilidad) / 100;
                ...
                if (IsNumeric(PrecioCosto))
                {
                    ...
                    PrecioVenta = (PrecioCosto * (1 + PUtilidad));
                }
                //PrecioUltimaCompra += PrecioFlete;

                //Este el proceso correcto..

                return String.Format("{0:C}", Math.Round(PrecioVenta, 2));
            }
        }
        ...
        public decimal TotalPrecioKit(ArrayList listProductos)
        {
            decimal TotalCostoKit = 0;
        ...
        public string ObtenerUtilidad_Neta(string PrecioVentaSugerido, decimal IVA, string PrecioUltimoCoso)
        {
            decimal PrecioCosto = decimal.Parse(PrecioUltimoCoso, System.Globalization.NumberStyles.Currency);
            decimal PrecioVenta = decimal.Parse(PrecioVentaSugerido, System.Globalization.NumberStyles.Currency);
            decimal PrecioFlete = 0, UtilidadNeta=0;

            if (IsNumeric(PrecioVenta) && IsNumeric(PrecioCosto))
            {
                //PrecioFlete = double.Parse(Flete, System.Globalization.NumberStyles.Currency);
                UtilidadNeta=((PrecioVenta) - PrecioCosto)/ PrecioCosto;
            }
            //PrecioUltimaCompra += PrecioFlete;

            return String.Format("{0:P}", Math.Round(UtilidadNeta,4));
        }
        public decimal ValorIva(int ClaveValor)
        {
            string Valor = GetStrFieldQuery("Valor", "Select Valor From CatImpuesto Where CveImpuesto=" + ClaveValor);
        ...
        {
            decimal PrecioUltimaCompra = decimal.Parse(UltimaCompra, System.Globalization.NumberStyles.Currency);
            decimal PrecioFlete = 0;
            if (IsNumeric(Flete))
            {
                PrecioFlete = decimal.Parse(Flete, System.Globalization.NumberStyles.Currency);
            }
            PrecioUltimaCompra += PrecioFlete;

            return String.Format("{0:C}", (PrecioUltimaCompra + (decimal.Parse(CheckTextBoxNull(UtilidadPrecio, "0", 1)))));
        }
        public string ObtenerUtilidad(string UltimaCompra, string Precio)
        {
            decimal PrecioUltimaCompra = decimal.Parse(UltimaCompra, System.Globalization.NumberStyles.Currency);
            decimal Precio1 = decimal.Parse(Precio, System.Globalization.NumberStyles.Currency);
        ...
        public string ObtenerPrecioUnitario(string CantidadCompra, string SubTotalCompra, string Flete, string TotalCompra)
        {
            ...
            decimal SubTotal = decimal.Parse(SubTotalCompra, System.Globalization.NumberStyles.Currency);
            decimal Cantidad = decimal.Parse(CantidadCompra, System.Globalization.NumberStyles.Currency);
            decimal Total = decimal.Parse(TotalCompra, System.Globalization.NumberStyles.Currency);
            decimal Flete2 = decimal.Parse(Flete, System.Globalization.NumberStyles.Currency);
            decimal PrecioFlete = 0;
        ...
        public decimal ObtenerGastosDirectos(decimal TotalCompra, decimal GastoDirecto)
        {
            decimal _result = 0;

            if (TotalCompra > 0)
                _result = GastoDirecto / TotalCompra;
            else
                _result = GastoDirecto;
        ...
        private void PageBase_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 27)
            {
                this.Close();
        ...
        public decimal LimiteCredito(string CveCliente)
        {
            decimal Credito = 0;
            float LimiteCredito = GetFloatField("LimiteCredito", "ClientesCredito", "CveCliente", CveCliente);


            return Credito=decimal.Parse(LimiteCredito.ToString());
        }
        public decimal SaldoCliente(string CveCliente)
        {
        ...
        public decimal ImportePagado(ArrayList Lista)
        {
            decimal Importe = 0, ImportePagado = 0;
        ...
        public decimal ImportePagadoNegocio(ArrayList Lista)
        {
            decimal Importe = 0, ImportePagado = 0;
            foreach (FormasPago item in Lista)
            {
        ...
        public decimal ImporteRealizado(ArrayList Lista)
        {
            decimal Importe = 0, ImportePagado = 0;
            foreach (FormasPago item in Lista)
            {
        ...
        /*
        public string Strconexion { get => strconexion; set => strconexion = value; }
        public string StrconexiongloblalMonar { get => strconexiongloblalMonar; set => strconexiongloblalMonar = value; }
        public string Strconexionlocalglobal { get => strconexionlocalglobal; set => strconexionlocalglobal = value; }
        */
        ...
        public void InsertaVentaAbierta(List<ProductoCompra> ListaVenta, int CveVentaTempB, int opcion)
        {
            ...
            else
            {
                ...
                using (SqlConnection con = new SqlConnection(Strconexion))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Producto.Cantidad = decimal.Parse(reader["Cantidad"].ToString(), System.Globalization.NumberStyles.Currency);
                        ...
                        Producto.PrecioUnitarioOriginal = decimal.Parse(reader["PrecioUnitarioOriginal"].ToString());
                        //Producto.PrecioUnitario = decimal.Parse(reader["PrecioUnitario"].ToString(), System.Globalization.NumberStyles.Currency);
                        Producto.Adicional = decimal.Parse(reader["Adicional"].ToString());
                        Producto.Subtotal = Producto.PrecioUnitario * Producto.Cantidad;
                        Producto.Descuento = decimal.Parse(CheckTextBoxNull(reader["Descuento"].ToString(), "0", 1));
                        ...
                        Producto.PDescuento = decimal.Parse(reader["PDescuento"].ToString());
        ...
        public void UpdateVentaTemp(int CveCliente, int CveVentaAbierta, int CveNoVentaTemp, string CveFormaPago, string CveVendedor, string CveFormaEntrega, string Observaciones, string strconexionLocal, int CveCaja, string NombreCliente, string Direccion, string Colonia, string Poblacion, int CveReceptor=0)
        {
            ...
            */
            ...
            string QueryInsertVenta = "Update VentaAbierta Set CveCliente=" + CveCliente + ", CveVendedor=" + CveVendedor + ", CveFormaPago=" + CveFormaPago + ", CveFormaEntrega=" + CveFormaEntrega + ", CveSucursal=" + CveSucursal + ",Observaciones='" + Observaciones + "',NombreCliente='" + NombreCliente + "',Direccion='" + Direccion + "',Colonia='"+ Colonia + "',Poblacion='" + Poblacion + "', CveReceptor=" + CveReceptor + " Where CveVentaTemp=" + CveVentaAbierta;
            //QueryInsertVenta += SwitchDate(DateTime.Now.ToShortDateString(), 2) + "',1," + CveSucursal + ")";
        ...
        public void InsertaVentaAbierta(List<ProductoCompra> ListaVenta, int CveVentaTempB, int opcion, string strconexion2, int option=0)
        {
            if (ListaVenta.Count > 0 || opcion == 1)
            {
                string QueryDelete = "Delete From VentaAbiertaDetalle Where CveVentaTemp=" + CveVentaTempB;
                ...
                foreach (var item in ListaVenta)
                {
                    ...
                    if (item.IntCveTipoDocumentoParent != 0)
                        CantidadReal = item.DblAfectar;
                    else
                    ...
                    if (item.Cantidad > 0)
                    {
                        ...
                        QueryInsert += "CvePrecio, PrecioUnitarioOriginal, PrecioUnitario,SubTotal, Descuento, Iva, SiIva, PIva,  PrecioTotal, PDescuento,CveAlmacen, CveTipoP, Pendiente, Afectar, Observaciones)";
                        QueryInsert += " Values(" + CveVentaTempB + "," + item.CveProducto + "," + CantidadReal + ",'" + item.Nombre + "','" + item.Clave + "',";
                        ...
                        QueryInsert += item.CveAlmacen + "," + item.IntCveTipoP + "," + item.DblPendiente + "," + item.DblAfectar + ",'" + item.StrObservaciones + "')";
            ...
            {
                ListaVenta.Clear();
                string QueryLista = "SELECT VAD.CveVentaDetalle,Va.CveVentaTemp, CveCliente, FechaVenta, CveProducto, Cantidad, Nombre, Clave, CvePrecio, PrecioUnitarioOriginal, PrecioUnitario, SubTotal, VAD.Descuento, Adicional, Iva, SiIVA, PIva, PrecioTotal, PDescuento, CveColor, CveAlmacen, CveNotaReferencia2, VAD.CveVendedor, NombreVendedor, CveTipoP,VAD.Pendiente, VAD.Afectar, VAD.Observaciones FROM VentaAbierta VA JOIN VentaAbiertaDetalle VAD ON VA.CveVentaTemp=VAD.CveVentaTemp WHERE VA.CveVentaTemp=" + CveVentaTempB;
                using (SqlConnection con = new SqlConnection(strconexion2))
                {
                    ...
                    while (reader.Read())
                    {
                        ProductoCompra Producto = new ProductoCompra(Strconexion);
                        Producto.Cantidad = decimal.Parse(reader["Cantidad"].ToString(), System.Globalization.NumberStyles.Currency);
                        Producto.DblAfectar = decimal.Parse(reader["Afectar"].ToString(), System.Globalization.NumberStyles.Currency);
                        Producto.CveProducto = reader["CveProducto"].ToString();
                        Producto.Nombre = reader["Nombre"].ToString();
                        ...
                        if (option == 0)
                        {
                            Producto.Descuento = Math.Round(((Producto.PrecioUnitarioOriginal * Producto.Cantidad)) * (Producto.PDescuento / 100), 2);  //float.Parse(CheckTextBoxNull(reader["Descuento"].ToString(), "0", 1));
                            Producto.Subtotal = Math.Round((Producto.PrecioUnitarioOriginal * Producto.Cantidad) - Producto.Descuento, 2);
                        }
                        else
                        {
                            Producto.Descuento = Math.Round(((Producto.PrecioUnitarioOriginal * Producto.DblAfectar)) * (Producto.PDescuento / 100), 2);  //float.Parse(CheckTextBoxNull(reader["Descuento"].ToString(), "0", 1));
                            Producto.Subtotal = Math.Round((Producto.PrecioUnitarioOriginal * Producto.DblAfectar) - Producto.Descuento, 2);
                        }
                        // Producto.Iva = (Producto.Subtotal - Producto.Descuento) - ((Producto.Subtotal - Producto.Descuento) / (1 + double.Parse(IvaF.ToString())));
                        //Producto.Subtotal = ((Producto.Subtotal - Producto.Descuento) / (1 + float.Parse(IvaF.ToString())));
                        ...
                        if (Producto.SIIVA == 1)
                        {
                            Producto.PIva = decimal.Parse(reader["PIva"].ToString());
                            Producto.Iva = Producto.Subtotal * Producto.PIva;
                            Producto.PrecioUnitario = Math.Round(Producto.PrecioUnitarioOriginal * (1 + Producto.PIva), 2);
                        }
                        else
                        {
                            Producto.Iva = 0;
                            Producto.PrecioUnitario = Producto.PrecioUnitarioOriginal;
                        }
                        */
                        ...
                        Producto.PrecioTotal = Math.Round(Producto.Subtotal + Producto.Iva, 2);
                        ...
                        Producto.CveEmpleado = int.Parse(reader["CveVendedor"].ToString());
                        Producto.NombreEmpleado = reader["NombreVendedor"].ToString();
                        Producto.DblPendiente = decimal.Parse(reader["Pendiente"].ToString());
                        Producto.DblAfectar = decimal.Parse(reader["Afectar"].ToString());
                        Producto.StrObservaciones = reader["Observaciones"].ToString();
                        //Producto.IntCveReceptor = int.Parse(reader["CveReceptor"].ToString());
                        ListaVenta.Add(Producto);
        ...
        public void InsertaVentaAbiertaConsulta(List<ProductoCompra> ListaVenta, int CveVentaTempB, int opcion, string strconexion2, int option = 0)
        {
            if (ListaVenta.Count > 0 || opcion == 1)
            {
                string QueryDelete = "Delete From VentaAbiertaDetalle Where CveVentaTemp=" + CveVentaTempB;
            ...
            {
                ListaVenta.Clear();
                string QueryLista = "SELECT VAD.CveVentaDetalle,VA.CveNota, VA.CveCliente, VA.Fecha, VAD.CveProducto, VAD.Cantidad, P.Nombre , P.CodigoProducto, VAD.CvePrecio, VAD.PrecioUnitarioOriginal, VAD.PrecioUnitario, VAD.SubTotal, VAD.Descuento, VAD.Iva, SiIva, PIva, VAD.Total, PDescuento, CveColor, VAD.CveAlmacen, VAD.CveNotaReferencia2, VA.CveVendedor, V.Nombre As NombreVendedor , VA.CveTipoDocumento, VAD.Pendiente, VAD.Afectar FROM Ventas VA JOIN VentasDetalle VAD ON VA.CveNota=VAD.CveNota Left Join Productos P on VAD.CveProducto=P.CveProducto Left Join Vendedores V on VA.CveVendedor=V.CveVendedor WHERE VA.CveNota=" + CveVentaTempB;
                using (SqlConnection con = new SqlConnection(strconexion2))
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand(QueryLista, con);
                    ...
                    while (reader.Read())
                    {
                        ...
                        Producto.Nombre = reader["Nombre"].ToString();
                        Producto.Nombre2 = reader["Nombre"].ToString();
                        Producto.Clave = reader["CodigoProducto"].ToString();
                        Producto.CvePrecio = int.Parse(reader["CvePrecio"].ToString());
                        Producto.PrecioUnitarioOriginal = decimal.Parse(reader["PrecioUnitarioOriginal"].ToString());
                        //Producto.PrecioUnitario = decimal.Parse(reader["PrecioUnitario"].ToString(), System.Globalization.NumberStyles.Currency);
                        //Producto.Adicional = decimal.Parse(reader["Adicional"].ToString());
                        ...
                        Producto.PrecioTotal = Math.Round(Producto.Subtotal + Producto.Iva, 2); //+(float)Producto.Iva;
        ...
        public void InsertaVentaAbierta(ArrayList ListaVenta, int CveVentaTempB, string strconexion2)
        {
        ...
        public void InsertaVentaAbierta_Grid(List<ProductoCompra> ListaVenta, int CveVentaTempB, int opcion, string strconexion2, int option=0)
        {
            if (ListaVenta.Count > 0 || opcion == 1)
            {
        ...
        public ArrayList InsertaVentaAbierta(int CveVentaTempB, string strconexion2, int option=0)
        {
            ArrayList ListaVenta = new ArrayList();
            
                string QueryLista = "SELECT VAD.CveVentaDetalle,VA.CveVentaTemp, CveCliente, CveReceptor, FechaVenta, CveProducto, Cantidad, Nombre, Clave, CvePrecio, PrecioUnitarioOriginal, PrecioUnitario, SubTotal, VAD.Descuento, Adicional, Iva, SiIva, PIva, PrecioTotal, PDescuento, CveColor, CveAlmacen, CveNotaReferencia2, VAD.CveVendedor, NombreVendedor, CveTipoP, VAD.Pendiente, VAD.Afectar, VAD.Observaciones FROM VentaAbierta VA JOIN VentaAbiertaDetalle VAD ON VA.CveVentaTemp=VAD.CveVentaTemp WHERE VA.CveVentaTemp=" + CveVentaTempB;
                using (SqlConnection con = new SqlConnection(strconexion2))
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand(QueryLista, con);
        ...
        public class ListaVentaAbiertas
        {
            ...
            public int IntCveDocumentoParent
            {
                get { return intCveDocumentoParent; }
                set { intCveDocumentoParent = value; }
            }
            ...
            public int Factura
            {
                get { return intFactura; }
                set { intFactura = value; }
            }
            ...
            using (SqlConnection con = new SqlConnection(Strconexionlocalglobal))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        item.IntCveDocumentoParent = int.Parse(reader["CveDocumentoParent"].ToString());
                        item.IntCveReceptor = int.Parse(reader["CveReceptor"].ToString());
                        lista.Add(item);
        ...
        public ArrayList ListaVentasActivas(int CveVentaTemp)
        {
            ArrayList lista = new ArrayList();
            using (SqlConnection con = new SqlConnection(Strconexionlocalglobal))
            {
                ...
                string query = "Select * From VentaAbierta Where CveVentaTemp=" + CveVentaTemp;
        ...
        public ArrayList ListaVentasActivas_Consulta(int CveVentaTemp)
        {
            ArrayList lista = new ArrayList();
            using (SqlConnection con = new SqlConnection(Strconexionlocalglobal))
            {
                ...
                string query = "Select * From Ventas Where CveNota=" + CveVentaTemp;
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    {
                        ListaVentaAbiertas item = new ListaVentaAbiertas();
                        item.CveVentaTemp = int.Parse(reader["CveNota"].ToString());
                        item.CveNoVentaTemp = int.Parse(reader["CveNota"].ToString());
                        item.CveCliente = int.Parse(reader["CveCliente"].ToString());
                        item.CveFormaEntrega = int.Parse(reader["CveFormaEntrega"].ToString());
                        item.CveFormaPago = int.Parse(reader["CveFormaPago"].ToString());
                        item.CveVendedor = int.Parse(reader["CveVendedor"].ToString());
                        item.Observaciones = reader["Observacion"].ToString();
                        item.NombreCliente = reader["NombreCliente"].ToString();
                        item.Direccion = reader["Direccion"].ToString();
                        item.Colonia = reader["Colonia"].ToString();
                        item.Poblacion = reader["Poblacion"].ToString();
                        ...
                        item.IntCveDocumentoParent = int.Parse(reader["CveDocumentoParent"].ToString());
                        item.IntCveReceptor = int.Parse(reader["CveReceptor"].ToString());
                        item.IntCveUser = int.Parse(reader["CveVendedor"].ToString());
                        item.IntCveMovimiento = int.Parse(reader["CveMovimiento"].ToString());
                        lista.Add(item);
        ...
        protected string GenerarFolio(string TipoDocumento)
        {
            ...
            Folio = string.Format("{0:000000}", FolioInt);
            
            return Folio;
        }

        protected bool IsDecimal(decimal num)
        {
        ...
        protected void GuardarImagenProducto(System.IO.MemoryStream img)
        {
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "Update Productos Set Imagen=@imagen Where CveEmpresa=1";
        ...
        protected void GuardarImagenLogo(System.IO.MemoryStream img)
        {
            ...
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "Update CatEmpresa Set logo=@imagen Where CveEmpresa=1";
        ...
        protected void GuardarImagen(System.IO.MemoryStream img, string Query, string Parametro)
        {
            ...
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                ...
                cmd.Parameters.Add(Parametro, System.Data.SqlDbType.Image);

                cmd.Parameters[Parametro].Value = img.GetBuffer();
        ...
        protected void GuardarImagenftp( string ftpUsername, string ftpPassword, string localFilePath, string NombreArchivo, int tipoimg=1)
        {
            string servidorftp = string.Empty;
            if (tipoimg == 1)
               servidorftp  = ConfigurationManager.AppSettings["servidorftpsecciones"].ToString();
            else
                servidorftp = ConfigurationManager.AppSettings["servidorftpmodelos"].ToString();


            using (WebClient client = new WebClient())
            {
                client.Credentials = new NetworkCredential(ftpUsername, ftpPassword);
                client.UploadFile(servidorftp + "//" + NombreArchivo, WebRequestMethods.Ftp.UploadFile, localFilePath);
            }


        }
        protected void GuardarImagenfac(System.IO.MemoryStream img)
        {
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "Update CatEmpresa Set logofactura=@imagen Where CveEmpresa=1";
        ...
        protected void GuardarImagenLoad(System.IO.MemoryStream img)
        {
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "Update CatEmpresa Set logoLoad=@imagen Where CveEmpresa=1";
        ...
        /// <summary>
        /// Funcion para obtener fecha y hora del servidor
        /// </summary>
        /// <param name="opcion"> opcion 1 para Fecha y opcion 2 para Hora</param>
        /// <returns></returns>
        ...
        protected void showImage(int CveProductoImagen, PictureBox picture)
        {
            picture.Image = null;
            ...
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand("SELECT Imagen FROM Productos WHERE CveProducto=" + CveProductoImagen, con);
                try
                {
                    ...
                    if (c > 0 && ds.Tables["BLOBTest"].Rows[0]["Imagen"].ToString() != "")
                    {
                        Byte[] byteBLOBData = new Byte[0];
                        byteBLOBData = (Byte[])(ds.Tables["BLOBTest"].Rows[c - 1]["Imagen"]);
        ...
        protected void showImage(string Query,string NombreCampo, PictureBox picture)
        {
            picture.Image = null;
            picture.ImageLocation = null;
            ...
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                ...
                try
                {
                    ...
                    if (c > 0 && ds.Tables["BLOBTest"].Rows[0][NombreCampo].ToString() != "")
                    {
                        Byte[] byteBLOBData = new Byte[0];
                        byteBLOBData = (Byte[])(ds.Tables["BLOBTest"].Rows[c - 1][NombreCampo]);
                        MemoryStream stmBLOBData = new MemoryStream(byteBLOBData);
                        picture.SizeMode = PictureBoxSizeMode.StretchImage;
                        picture.Image = Image.FromStream(stmBLOBData);
        ...
        protected void showImageDetalle(int CveDetalleImagen, PictureBox picture)
        {
            picture.Image = null;
            picture.ImageLocation = null;
            ...
            using (SqlConnection con = new SqlConnection(Strconexion))
            {
                SqlCommand cmd = new SqlCommand("SELECT Imagen FROM DetalleImagenProducto WHERE CveDetalleImagen=" + CveDetalleImagen, con);
                try
                {
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    DataSet ds = new DataSet();
        ...
        protected void SetDBLogonForReport(ReportDocument mRD)
        {
        ...
        protected void SetDBLogonForReport_A(ReportDocument mRD)
        {


            ConnectionInfo crystalcon = new ConnectionInfo();
            crystalcon.ServerName = ConfigurationManager.AppSettings["ServerReport_A"]; //ServerName.Id_ServerName; //"172.16.1.235";
            crystalcon.DatabaseName = ConfigurationManager.AppSettings["DataBaseReport_A"]; //BaseDatos.Id_BaseDatos; //"SEEAtiende";
            crystalcon.UserID = ConfigurationManager.AppSettings["UserDBReport_A"]; //IdUserName.IdUser_Name; //"STAtiende";
            crystalcon.Password = ConfigurationManager.AppSettings["PasswordDBReport_A"]; //IdPassWord.Id_PassWord;  //"$A%43NA";
        ...
        protected DataTable SP_Busca_Reader_Query(string QueryTable)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Strconexion))
            {
                ...
                SqlCommand cmd = new SqlCommand(QueryTable, cn);
        ...
        protected bool ImprimirVenta(ArrayList arraylistInstanceRef )
        {
            bool imprimir = false;

            //double Efectivo = double.Parse(txtPago.Text, System.Globalization.NumberStyles.Currency);

            //int TipoImpresion = int.Parse(GetStrFieldQuery("Tamano", "Select Tamano From CatCajas Where CveCaja=" + CveCaja));
            //string NombreImpresora = GetStrFieldQuery("Impresora", "Select Impresora From CatCajas Where CveCaja=" + CveCaja);

                Punto_de_Venta.Reportes.RptTiket80Remision18_R_Vta ReporteTiket = new Punto_de_Venta.Reportes.RptTiket80Remision18_R_Vta();
                //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord, ServerName.Id_ServerName, BaseDatos.Id_BaseDatos);

                SetDBLogonForReport(ReporteTiket);

            foreach (ProductoCompra item in arraylistInstanceRef)
            {

                SetParamValueReporte("?CveNota", item.IntCveNotaGenera.ToString(), ReporteTiket);

                try
                {

                    //ReporteTiket.PrintOptions.PrinterName = NombreImpresora;

                    if (item.CveFormaPago == 2)
                    {
                        SetParamValueReporte("?nCopia", "1", ReporteTiket);
                        ReporteTiket.PrintToPrinter(1, true, 0, 0);
                        SetParamValueReporte("?nCopia", "2", ReporteTiket);
                        ReporteTiket.PrintToPrinter(1, true, 0, 0);
                        SetParamValueReporte("?nCopia", "3", ReporteTiket);
                        ReporteTiket.PrintToPrinter(1, true, 0, 0);
                    }
                    else
                    {
                    ...
                    if (item.CveFormaEntrega == 1)
                    {
                        SetParamValueReporte("?nCopia", "4", ReporteTiket);
                        ReporteTiket.PrintToPrinter(1, true, 0, 0);
                ...
                {
                    MessageBox.Show("No tiene una impresora instalada", "Error Imprimir Ticket");
                }
            }

            ReporteTiket.Close();
            ReporteTiket.Dispose();

            
            return imprimir;
        }
        protected bool ImprimirVenta(List<ProductoCompra> arraylistInstanceRef)
        {
            bool imprimir = false;
            ...
            foreach (var item in arraylistInstanceRef)
            {
        ...
        protected bool ImprimirVenta(int CveDocumento, int CveFormaPago, int CveFormaEntrega)
        {
            bool imprimir = false;
            ...
            if(CveDocumento>0)
            {
                ...
                SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiket);
                ...
                {
                    MessageBox.Show("No tiene una impresora instalada" + " Error: " + err.Message, "Error Imprimir Ticket");
                }
            }
        ...
        protected bool ImprimirDocumento_RemsionCopia(bool Impresion, int CveTipoDocumento, int CveTipoDocumento_Parent, int CveDocumento, int IntCveFormaPago)
        {
            bool regresa = false;

            double Efectivo = 0;// double.Parse(txtPago.Text, System.Globalization.NumberStyles.Currency);

            int TipoImpresion = 80;// int.Parse(GetStrFieldQuery("Tamano", "Select Tamano From CatCajas Where CveCaja=" + CveCaja));
                                   //string NombreImpresora = GetStrFieldQuery("Impresora", "Select Impresora From CatCajas Where CveCaja=" + CveCaja);
            if (Impresion)
            {
                ...
                if (TipoImpresion == 80)
                {
                    ...
                    switch (CveTipoDocumento)
                    {
                        case 1:
                        case 4:
                            //SetParamValueReporte("?Efectivo", Efectivo.ToString(), ReporteTiket);
                            try
                            {
                                //ReporteTiket.PrintOptions.PrinterName = NombreImpresora;

                                switch (IntCveFormaPago)  // Formas de Pago
                                {
                                    case 1:   // de Contado

                                        if (CveTipoDocumento_Parent == 16)
                                        {
                                            Punto_de_Venta.Reportes.RptTiket80Remision18_R_RemisionCS ReporteTiketCS = new Punto_de_Venta.Reportes.RptTiket80Remision18_R_RemisionCS();
                                            //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Password, ServerName.Id_ServerName, BaseDatos.Id_BaseDatos);
                                            SetDBLogonForReport(ReporteTiketCS);
                                            //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                            SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiketCS);
                                            SetParamValueReporte("?nCopia", "1", ReporteTiketCS);
                                            ReporteTiketCS.PrintToPrinter(1, true, 0, 0);

                                            ReporteTiketCS.Close();
                                            ReporteTiketCS.Dispose();
                                        }
                                        else
                                        {
                                            Punto_de_Venta.Reportes.RptTiket80Remision18_1 ReporteTiket = new Punto_de_Venta.Reportes.RptTiket80Remision18_1();
                                            //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Password, ServerName.Id_ServerName, BaseDatos.Id_BaseDatos);
                                            SetDBLogonForReport(ReporteTiket);
                                            //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                            SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiket);
                                        ...
                                        break;
                                    case 2:  // Credito
                                        Punto_de_Venta.Reportes.RptTiket80Remision18_1 TicketCredito = new Punto_de_Venta.Reportes.RptTiket80Remision18_1();
                                        //TicketCredito.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                        SetDBLogonForReport(TicketCredito);
                                        SetParamValueReporte("?CveNota", CveDocumento.ToString(), TicketCredito);
                                        TicketCredito.PrintToPrinter(1, true, 0, 0);
                                        TicketCredito.Close();
                                        TicketCredito.Dispose();

                                        break;
                                    case 3:   // por Cobrar
                                              /*
                                              Punto_de_Venta.Reportes.RptTiket80Remision18_R_Remision TicketRemision = new Reportes.RptTiket80Remision18_R_Remision();
                                              TicketRemision.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                              SetParamValueReporte("?CveNota", inserted.ToString(), TicketRemision);
                                              SetParamValueReporte("?nCopia", "1", TicketRemision);
                                              TicketRemision.PrintToPrinter(1, true, 0, 0);

                                               SetParamValueReporte("?nCopia", "2", TicketRemision);
                                              TicketRemision.PrintToPrinter(1, true, 0, 0);
                                              */

                                        Punto_de_Venta.Reportes.RptTiket80Remision18_1 ReporteTiketPorCobrar = new Punto_de_Venta.Reportes.RptTiket80Remision18_1();
                                        //ReporteTiketPorCobrar.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Password, ServerName.Id_ServerName, BaseDatos.Id_BaseDatos);    
                                        SetDBLogonForReport(ReporteTiketPorCobrar);
                                        //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                        SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiketPorCobrar);
                                        ReporteTiketPorCobrar.PrintToPrinter(1, true, 0, 0);
                                        ReporteTiketPorCobrar.Close();
                                        ReporteTiketPorCobrar.Dispose();
                            ...
                            {
                                MessageBox.Show("No tiene una impresora instalada..." + err.Message, "Error Imprimir Ticket");
                            }
                        ...
                        case 2:
                            ...
                            try
                            {
                                Punto_de_Venta.Reportes.RptTiket80Remision18_R_Cotizacion ReporteTiketCotizacion = new Punto_de_Venta.Reportes.RptTiket80Remision18_R_Cotizacion();
                                //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Password, ServerName.Id_ServerName, BaseDatos.Id_BaseDatos);
                                SetDBLogonForReport(ReporteTiketCotizacion);
                                //ReporteTiket.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                                SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiketCotizacion);
                                SetParamValueReporte("?nCopia", "1", ReporteTiketCotizacion);
                                ReporteTiketCotizacion.PrintToPrinter(1, true, 0, 0);

                                ReporteTiketCotizacion.Close();
                                ReporteTiketCotizacion.Dispose();
                            }
                            catch
                            {
                ...
                {
                    Punto_de_Venta.Reportes.RptTiket56 ReporteTiket1 = new Punto_de_Venta.Reportes.RptTiket56();
                    ReporteTiket1.SetDatabaseLogon(IdUserName.IdUser_Name, IdPassWord.Id_PassWord);
                    SetParamValueReporte("?CveNota", CveDocumento.ToString(), ReporteTiket1);
                    SetParamValueReporte("?Efectivo", Efectivo.ToString(), ReporteTiket1);
                    try
                    {
                        // ReporteTiket1.PrintOptions.PrinterName = NombreImpresora;
                        ReporteTiket1.PrintToPrinter(1, true, 0, 0);

                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show("No tiene una impresora instalada.." + ex.Message, "Error Imprimir Ticket");
                    }
                }
        ...
        public decimal ActualizarSaldoCuentasPorCobrar(int CveCuenta)
        {


            decimal TotalAbonos = decimal.Parse(GetStrFieldQuery("Abonos", "SELECT ISNULL(SUM(Importe),0) AS Abonos FROM CuentasPorCobrarAbonos WHERE CveEstatus=1 AND CveCuenta=" + CveCuenta));
            decimal TotalNotasCredito = decimal.Parse(GetStrFieldQuery("AbonosNC", "SELECT ISNULL(SUM(Importe),0) AS AbonosNC FROM NotasdeCredito NC LEFT JOIN NotadeCreditoMetodoPago DFPNC ON NC.CveNotaDeCredito=DFPNC.CveNotadeCredito  WHERE NC.CveDocumento=" + CveCuenta));

            decimal SaldoInicial = decimal.Parse(GetStrFieldQuery("Importe", "Select Importe From CuentasPorCobrar Where CveCuenta=" + CveCuenta));

            decimal Saldo = SaldoInicial - TotalAbonos - TotalNotasCredito;

            string QueryUpdate = "Update CuentasPorCobrar Set Saldo=" + Saldo + " Where CveCuenta=" + CveCuenta;
            performupdatequery(QueryUpdate);

            return Saldo;
        }
        public int ValidarAperturaCaja()
        {
            int CveCaja = 0;
            ...
            {
                con.Open();
                string QueryApertura = "Select * From CierreCajas Where Fecha='" + SwitchDate(DateTime.Now.ToShortDateString(), 1) + "' And CveUser=" + CveUser.Cve_User + " And Cerrada=0";
                ...
                {
                    ReaderCierre.Read();
                    CveCaja = int.Parse(ReaderCierre["CveCaja"].ToString());
                    //ProvisionInicial = decimal.Parse(ReaderCierre["ProvisionInicial"].ToString());
        ...
        public int OperacionCaja(int opcion = 0)
        {
            int Retorno = 0;
            ...
            int CveAlmacen = 0, CveCierre = 0;
            bool Esta = false;

            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["SqlMonar"].ConnectionString))
            {
                con.Open();
                string QueryApertura = "Select * From CierreCajas Where Fecha='" + c.SwitchDate(DateTime.Now.ToShortDateString(), 1) + "' And CveUser=" + CveUser.Cve_User + " And Cerrada=0";
                SqlCommand CmdCierre = new SqlCommand(QueryApertura, con);
                SqlDataReader ReaderCierre = CmdCierre.ExecuteReader();
                ...
                if (ReaderCierre.HasRows)
                {
                    ...
                    CveAlmacen = int.Parse(ReaderCierre["CveAlmacen"].ToString());
                    CveCierre = int.Parse(ReaderCierre["CveCierre"].ToString());

                    var configFile = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None);
                    var settings = configFile.AppSettings.Settings;


                    settings["CveCaja"].Value = CveCaja;
                    settings["CveAlmacen"].Value = CveAlmacen.ToString();
                    settings["CveCierre"].Value = CveCierre.ToString();
                    settings["CveUser"].Value = CveUser.Cve_User.ToString();
                    settings["CveVendedor"].Value = CveUser.Cve_User.ToString();
            ...
            if (Esta)
            {
                ...
                switch (opcion)
                {
                    case 0: // Cobro de Remisiones

                        Punto_de_Venta.FormControlRemisiones FrmControlRemisiones = new Punto_de_Venta.FormControlRemisiones();
                        //FrmControlRemisiones

                        FrmControlRemisiones.CveCaja = CveCaja;
                        FrmControlRemisiones.IntCveCierre = CveCierre;
                        FrmControlRemisiones.Caja = DescripcionCaja;
                        FrmControlRemisiones.FechaVta = DateTime.Now.ToShortDateString();
                        FrmControlRemisiones.ProvisionInicial = c.CheckTextBoxNull(ProvisionInicial.ToString(), "0", 1);
                        //FrmControlRemisiones.CveAlmacenDefault = CveAlmacen;
                        //FrmControlRemisiones.MdiParent = FormMenuPrincipal.ActiveForm;

                        FrmControlRemisiones.Show();


                        break;
                    case 1: // Cancelacion de Remisiones 

                        Punto_de_Venta.FormControlVentasCancelar FrmControlVentaC = new Punto_de_Venta.FormControlVentasCancelar();
                        //FrmControlRemisiones

                        FrmControlVentaC.CveCaja = CveCaja;
                        FrmControlVentaC.IntCveCierre = CveCierre;
                        FrmControlVentaC.Caja = DescripcionCaja;
                        FrmControlVentaC.FechaVta = DateTime.Now.ToShortDateString();
                        FrmControlVentaC.ProvisionInicial = c.CheckTextBoxNull(ProvisionInicial.ToString(), "0", 1);
                        //FrmControlRemisiones.CveAlmacenDefault = CveAlmacen;
                        //FrmControlVentaC.MdiParent = FormMenuPrincipal.ActiveForm;

                        FrmControlVentaC.Show();

                        break;
                    case 2:

                        CuentasxCobrar.FormCuentasxCobrar CxCobrar = new CuentasxCobrar.FormCuentasxCobrar();
                        //CxCobrar.MdiParent = this;
                    ...
                    case 4: // Cobro de PosVenta

                        Punto_de_Venta.Pos.FrmPosVenta frmPosVenta = new Punto_de_Venta.Pos.FrmPosVenta();
                        //FrmControlRemisiones

                        frmPosVenta.CveCaja = CveCaja;
                        frmPosVenta.IntCveCierre = CveCierre;
                        frmPosVenta.Caja = DescripcionCaja;
                        frmPosVenta.Fecha = DateTime.Now.ToShortDateString();
                        frmPosVenta.ProvisionInicial = c.CheckTextBoxNull(ProvisionInicial.ToString(), "0", 1);
                        //FrmControlRemisiones.CveAlmacenDefault = CveAlmacen;
                        //FrmControlRemisiones.MdiParent = FormMenuPrincipal.ActiveForm;
        ...
        public decimal SumaTotales(DataGridView grid, string Columna)
        {
            decimal suma = 0;

            foreach (DataGridViewRow row in grid.Rows)
            {
                suma += decimal.Parse(row.Cells[Columna].Value.ToString());
            }
        ...
        public static string GetSafeCodigoPostal(string value)
        {
            var relleno = Convert.ToChar("0");
            var result = GetSafeString(value);
            if (result != null)
                result = result.PadLeft(5, relleno);

            return result;
        }

        protected string leerCertificado(string certificado)
        {
            string serie = "";

            var cer = new USLib.Utilerias.Certificado.Certificado();
            if (cer.LeerCertificado(@certificado))
            {
            ...
            {
                //Error de lectura
                MessageBox.Show(cer.MensajeError);
            }


            return serie;
        }
        protected string datosLCO(string serie)
        {
            string Datos = "";

            //Valida si un número de serie de un certificado existe en la lista de LCO
            var certificadoLco = USLib.WebServices.Utilerias.FachadaUtileriasWs.LCOObtenCertificado(serie: serie);
            if (certificadoLco != null)
            {
                Datos += certificadoLco.Rfc + Environment.NewLine;
                Datos += certificadoLco.EstatusCertificado + Environment.NewLine;
                Datos += certificadoLco.FechaFin.ToString("s") + Environment.NewLine;
                Datos += certificadoLco.NoCertificado + Environment.NewLine;
                Datos += certificadoLco.ValidezObligaciones + Environment.NewLine;
            }
            else
            {
                MessageBox.Show("El número de serie del certificado no existe en la lista de LCO");
            }
        ...
        public string ObtenerHostPublico()
        {
        ...
        protected DataTable SP_Busca_Reader_Query_Monar(string QueryTable)
        {

            DataTable Table = new DataTable();
            using (SqlConnection cn = new SqlConnection(StrconexiongloblalMonar))
            {
                cn.Open();
